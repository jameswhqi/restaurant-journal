...
<SelectPortal {...portalProps}>
	...
	>
		...
		<SelectPrimitive.Viewport
			class={cn(
				"max-h-(--bits-select-content-available-height) w-full min-w-(--bits-select-anchor-width) scroll-my-1"
			)}
		>
			{@render children?.()}
		</SelectPrimitive.Viewport>
